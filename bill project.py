...
def welcome():
    ...
    textarea.insert(END,"\t  Welcome to Shads SuperMarket")
...
title=Label(root,pady=2,text="SHADS SUPERMARKET",bd=12,bg=bg_color,fg='white',font=('times new roman', 25 ,'bold'),relief=GROOVE,justify=CENTER)
title.pack(fill=X)
...
bill_title=Label(F3,text='Receipt',font='arial 15 bold',bd=7,relief=GROOVE).pack(fill=X)
